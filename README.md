...
5. 🧹 Remove an existing user (optional, interactive)  
6. 🕰️  Set timezone → `Europe/Amsterdam`  
7. 🧰 Install QEMU Guest Agent, zip/unzip, and enable getty@tty1  
...
- After enabling QEMU Guest Agent, you can safely remove the serial port and set Display → **Default (VNC console)**.  
...
7. VM is now **ready for cloning & production use** 🚀  
